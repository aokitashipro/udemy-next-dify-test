    ...
    try{
        ...
        if(subscriptionItem){
            if(subscriptionItem.current_period_start){
                updateData.currentPeriodStart = new Date(subscriptionItem.current_period_start * 1000)
            }
            if(subscriptionItem.current_period_end){
                updateData.currentPeriodEnd = new Date(subscriptionItem.current_period_end * 1000)
            }
        }
